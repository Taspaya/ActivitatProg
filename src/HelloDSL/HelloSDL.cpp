...
void Init(SDL_Window* &window, SDL_Renderer* &renderer) {
	...
	window = SDL_CreateWindow("Hello SDL", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_MAXIMIZED | SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
	//                   Caption(titol)  , Posicio referent al monitor                     ,                             , Flags tipo de ventana
